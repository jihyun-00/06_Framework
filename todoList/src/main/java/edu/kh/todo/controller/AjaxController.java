 ...
 * 
 * -> 해당 어노테이션이 붙은 컨트롤러의 메서드는 return에 작성된 값이 forward/redirect로 인식 X
 * 
 * @RequestBody
 ...
 *  
 *  (참고)
 *  Spring에서 HttpMessageConveror 작동하기 위해서는
...
public class AjaxController {
	...
	// -> 반환되어야 하는 결과값의 자료형을 반환형에 써야 함!
	@ResponseBody // 반환값을 HTTP 응답 본문으로 직접 전송 (값 그대로 돌려보낼 거야!!)
