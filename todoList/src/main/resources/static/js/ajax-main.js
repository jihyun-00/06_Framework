...
function getTotalCount() { // 함수 정의
  ...
  .then( result => { // 첫번째 콜백함수가 완료된 후 호출되는 콜백 함수
...
addBtn.addEventListener("click", () => {
  ...
  // - 전달 데이터 : todoTitle값, todoContent 값
  // JS <-> Java
...
updateView.addEventListener("click", () => {
  ...
  updateBtn.setAttribute("date-todo-no", popupTodoNo.innerText);
