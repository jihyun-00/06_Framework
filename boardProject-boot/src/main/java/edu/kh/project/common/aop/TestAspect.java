...
/*
 * Aspect-Oriented Programing의 약자로, 분산되어 있는 관심사/관점을 모듈화 시키는 기법
 * 
 ...
 * - @Around(포인트컷) : 대상 메서드(포인트컷) 실행 전/후로 Advice를 실행함(@Before + @After) 
 * 
 */

@Component // 해당 클래스 Bean 등록 / @Bean : 개발자가 수동으로 만든 것을 Bean 등록
