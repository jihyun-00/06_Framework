...
public class LoggingAspect {
	...
	// * 주의할 점 *
	// 1) @Around 사용 시 반환형 Object여야 함
	// 2) @Around 메서드 종료 시 proceed() 반환값을 return 해야한다
	
	@Around("PointcutBundle.serviceImplPointcut()")					// Throwable : Exception의 부모
	...
	@AfterThrowing(pointcut="@annotaion(org.springframework.transaction.annotation.Transactional;)", throwing="ex")
